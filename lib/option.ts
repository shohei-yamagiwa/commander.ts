...
type ImpliedOptionValues = Record<string, unknown>;
...
class Option {
  ...
  public presetArg: unknown;
  public envVar: string | undefined;
  public parseArg: OptionParser | undefined;
  public hidden: boolean;
  public argChoices: string[] | undefined;
  public conflictsWith: string[];
  public implied: ImpliedOptionValues | undefined;
  public helpGroupHeading: string | undefined;
   ...
   * @return {Option}
   */
  implies(impliedOptionValues: ImpliedOptionValues | string): Option {
    let newImplied: ImpliedOptionValues | string = impliedOptionValues;
   ...
   * @return {Option}
   */
  argParser(fn?: OptionParser): Option {
    this.parseArg = fn;
    return this;
  }
   ...
   * @return {Option}
   */
  helpGroup(heading: string): Option {
 ...
 */
class DualOptions {
  public positiveOptions: Map<string, Option>;
  public negativeOptions: Map<string, Option>;
  public dualOptions: Set<string>;
